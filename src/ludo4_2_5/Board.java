...
public class Board {
    ...
    /**
     * setField updates the tokens position on the board
     * 
     * @param turn
     * @param oldField
     * @param newField 
    ...
    /**
     * pH(player Home) Shows if token is at its home field
     *
     * @param player
     * @param playerNumber
     * @param tokenNumber
    ...
    /**
     * pF(player Finished) Show if token is at its end fields
     * 
     * @param player
     * @param playerNumber
     * @param field
    ...
    /**
     * s(score) Shows the number of tokens finished for each player
     * 
     * @param player
     * @param playerNumber
     * @return 
     */
    String s(Player player[], int playerNumber) {
        String score = "";
        if (player.length > playerNumber) {
    ...
    void printBoard(Player pl[]) {
        System.out.println();
        System.out.println(s(pl, 0) + "        " + p[12] + " " + p[13] + " " + p[14] + "        " + s(pl, 1));
        ...
        System.out.println(s(pl, 3) + "        " + p[42] + " " + p[41] + " " + p[40] + "        " + s(pl, 2));
        System.out.println();
    }
}
